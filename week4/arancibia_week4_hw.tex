...
\NormalTok{results <-}\StringTok{ }\KeywordTok{computeMinhashSigs}\NormalTok{(hashlist, setlist)}
...
\NormalTok{result <-}\StringTok{ }\KeywordTok{computeMinhashSigs}\NormalTok{(hashlist, setlist)}
\NormalTok{result}
\end{Highlighting}
\end{Shaded}
